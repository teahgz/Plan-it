...
<body>
    ...
    <div id="update_task_wrap">
		...
		<form id="taskUpdateFrm">
			<div class="form_group">
				<label for="task_title">할 일</label> <input type="text"
					id="task_title" name="task_title" value="${task.task_title}"
					required>
			</div>
	...
	form.addEventListener('submit', (e) => {
		...
		if(vali_check == false){
			...
			fetch('<%=request.getContextPath()%>/task/update/${task.task_no}',{
				method : 'POST',
				headers : {
